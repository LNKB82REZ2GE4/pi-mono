...
## Local Workflow Context (Personal Fork)
- Always read `/home/jake/pi-mono/DEVELOPMENT.md` before starting work in this repository.
- Follow `DEVELOPMENT.md` for promotion workflows (commit/push/rebuild for pi-mono and plugins).
...
This project is indexed by GitNexus as **pi-mono** (5632 symbols, 16556 relationships, 300 execution flows).
